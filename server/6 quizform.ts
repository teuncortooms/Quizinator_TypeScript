...
//  var exercisesTable = [];
  ...
  for (i = 0; i < exercises.length - 1; i++){    // for each exercise in array (-1 to ignore quiz title at end of array)
     var header = quizForm.addSectionHeaderItem();    //append heading into doc
